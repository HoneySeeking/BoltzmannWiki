# Traits
- You are encouraged to flavor your various traits as pertaining to your character
	- eg. **Naturally armored** is actually thick fur
- You start with ancestral traits for free
- You spend ego on learned traits
- You gain magical traits through spirit possession

# Ancestral Traits
The forest is full of all sorts of creatures. Decide what your creature looks like (eg. raccoon, hedgehog, turtle, a rodent of an unusual size), and pick 3 of the traits below. Your creature starts at a raccoon sized ground dwelling creature. You can pick up to two negative traits to get another positive trait. Any number in parenthesis after the name indicates how many traits this costs. You can't get additional ancestral traits by paying ego, but for the purposes of totem calculation, each of these cost 2 times the cost ego. Traits that make sense to stack can be taken multiple times.
...
- **Catlike Reflexes**. Half fall damage; stacks multiplicatively. Getting up from [[Prone]] is a free action.
...
# Learned Traits
- Each trait costs 1 ego
- If the trait has a number in parenthesis, that's the cost instead of 1

## Craftsman Traits
- **Reliable Talent**. For a specific skill, if you roll below the expected value, you can take the expected value rounded up. Can be taken multiple times for multiple skills.

## Social Traits
- **Actor**. You can mimic the voice of anyone you have heard, and any animal noises.
- **Henchkeeper**. #todo something something can find an unimportant henchman or swarmkeeper shenanigans
- **Racism**. Choose one type of animal. You have advantage on Survival checks to track them, History/Nature checks to recall information about them. Advantage on attack rolls against them.
- **Quipu**. You can read and write [[Languages#Quipu]]
- **Blade Script**. You can read and write [[Languages#Bear Script]]
- **Webspeak**. Requires Seismicsense. Learn [[Languages#Webspeak]]

## Shaman Traits
- **Aura**. You can cast spells with the Aura delivery
- **Bolt**. You can cast spells with the Bolt delivery
- **Cone**. You can cast spells with the Cone delivery
- **Line**. You can cast spells with the Line delivery
- **Sphere**. You can cast spells with the Sphere delivery

- **Illusionist**. Illusion spells can now completely change the nature of the illusion as the spell maintenance action
- **Illusory Eyes**. Illusions of creatures are valid targets of [[Tap Sense]] for you.
...
- **Defensive Duelist**. You can use the weapon attack dice instead of a dex check for a resist/dodge action against melee attacks against you.
- **Dual Wielder** (2). Can attack with both weapons as part of the same action. The total damage is VIT + left weapon damage + right weapon damage
- **Executioner**. Every attack that kills something grants you another action. 
- **Escapist**. Disengage action no longer halves your pace. 
...
- **Sentry**. If you kill something with an exploit attack, you regain another action.
...
- **Demonic Presence** (5). You can't be perceived unless you want to be or in combat. #todo
- **Extra Arms** (2). You grow and extra pair of arms that can wield weapons and provide with you with an action per turn that can be only used to attack with these arms
- **Essence Shift**. #todo something that steals attributes through attacks that deal vitality damage? temp attribute buffs for eating corpses? 
- **Masked Pheromones** (2). You can make your pheromones smell like it comes from a different creature you have smelled before
- **Morph**. As an action move one ego from VIT to AGI or back.
- **Oppressive Possession**. Your racial traits are replaced by the traits gained by channeling this spirit
- **Repressive Possession**. Your mind takes a step back as your body is piloted by the spirit possessing you.
- **Shapechanger** (depends on animal). You can turn into specific animal and back as an action. You use your attributes, but replace your ancestral traits with the animals. 
- **Synesthesia** (3). Excellence in one sense can be used in place of any other sense you have.
- **Scentless** (3). Impossible to detect through scent and leaves no pheromone markers.
- **Troll Regeneration** (3). Can't die unless taken taken energy damage the same round
- **Legendary Resillience** (4). You automatically pass any resist checks whose DC is lower than your expected value
- **Legendary Resistance** (5). You always have an action available for the [[Combat Rules#Resist]] action
- **Legendary Speed** (5). You can take an action at the end of every enemy you're fighting against
- **Magical Tracker** (2). If you have a piece of body part of someone like nails, teeth, hair you get a general sense of direction to them and how far they are
- **Spell Effect** (equal to cost of effect). You are permanently under a magical [[Effects|effect]].

---
- **Fertile Skin**. Small seedlings and miniature life sprouts from under your skin. They are painful at times and will continue to grow despite your best efforts
